...
class AppColors {
  // PRIMARY (Teal)
  static const Color primary = Color(0xFF0F8072);        // Light mode
  static const Color primaryDark = Color(0xFF4DB6AC);    // Dark mode
  static const Color primaryVariant = Color(0xFF0E6F61); // Darker shade
  ...
  // TEXT
  static const Color textPrimary = Color(0xFF102A2A);
  static const Color textSecondary = Color(0xFF4F6F6B);
